...
dashboard/   Next.js agent/admin dashboard
docs/        Development notes (module-by-module) and DEPLOYMENT.md
```
...
Full setup, testing, and module-by-module design notes are in
`docs/development/`. Production deployment — environment variables,
